...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.80964c66c4a73d8abb64626cee5eabd9996908a5b311043e3f5a39c37cb5efcb.js',function(){input.required=false;search();});}
