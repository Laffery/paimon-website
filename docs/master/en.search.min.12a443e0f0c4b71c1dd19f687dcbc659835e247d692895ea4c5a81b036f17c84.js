...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.8029c54b30d2614597ad6bc267dce591e2dfe548b2ef23fdcd49c7cd52019c71.js',function(){input.required=false;search();});}
