...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.b52dac8f5a819cf09bfed28f36c8f86bc375f6e52849cb81732b743cceb1d44d.js',function(){input.required=false;search();});}
