...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.ca75f28d90c99f1587f92cd8373ec9a83ba11b026978e94f928d3bf1f61bbca1.js',function(){input.required=false;search();});}
