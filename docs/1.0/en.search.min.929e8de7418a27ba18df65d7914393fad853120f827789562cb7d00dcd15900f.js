...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.dcfc4edd8423c1769c8e8e47d74c29d9f1692c0448a3c0b6de280b6cb12fb2b1.js',function(){input.required=false;search();});}
