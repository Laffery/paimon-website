...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.dd4afad46aab78bffe2899b65531412d00db3019502eb1da17b3215d8cca0879.js',function(){input.required=false;search();});}
