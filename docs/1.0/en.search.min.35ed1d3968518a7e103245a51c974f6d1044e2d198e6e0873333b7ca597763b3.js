...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.0/flexsearch.min.js');loadScript('/docs/1.0/en.search-data.min.a78e00a1e6d4a6fd800910c940f21097e231ef10b74229971153d779730a9602.js',function(){input.required=false;search();});}
